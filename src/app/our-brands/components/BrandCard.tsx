...
export default function BrandCard({
  ...
  return (
    <article className="overflow-hidden rounded-2xl border border-[rgba(212,175,55,0.2)] bg-white shadow-[0px_2px_12px_rgba(0,0,0,0.05)]">
      <div
      ...
      <div className="px-8 pb-8 pt-9">
        <h4 className="mb-[19px] text-2xl font-bold leading-[38.4px] text-[#2D5016]">{name}</h4>
        <p className="mb-[22px] text-[15.2px] italic leading-[24.32px] text-[#8B8B8B]">
          &ldquo;{tagline}&rdquo;
        </p>
        <p className="mb-[30px] text-base leading-[27.2px] text-[#2C2C2C]">{description}</p>

        <p className="mb-[19px] text-[13.6px] font-semibold uppercase leading-[21.76px] tracking-wide text-[#2D5016]">
          {listLabel}
        </p>
        <ul className="mb-6 space-y-[15.7px]">
          {items.map((item) => (
