...
const links = [
  ...
  { href: "#policies-governance", label: "Policies & Governance" },
  { href: "#risk-assessment", label: "Risk Assessment" },
  { href: "#due-diligence", label: "Due Diligence" },
  { href: "#supplier-standards", label: "Supplier Standards" },
  { href: "#remediation", label: "Remediation" },
  { href: "#training", label: "Training & Awareness" },
  { href: "#reporting", label: "Reporting" },
  { href: "#kpis", label: "Measuring Effectiveness" },
  { href: "#approval", label: "Statement Approval" },
];
